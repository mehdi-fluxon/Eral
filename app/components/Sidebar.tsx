...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  const menuItems = [
    ...
    { href: '/team', label: 'Team', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z' },
    ...
    <>
      ...
      `}>
                ...
                <li key={item.href}>
                  <Link
                    ...
                    className={`
                      ...
                      ${isActive 
                        ? 'bg-[#123ef6] text-white' 
                        : 'text-gray-700 hover:bg-gray-100 hover:text-[#123ef6]'
                      }
                    `}
                  >
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <div className="bg-gradient-to-r from-[#123ef6] to-[#0d3a9a] rounded-lg p-4 text-white">
            <h3 className="font-semibold mb-1">Need Help?</h3>
            <p className="text-sm opacity-90 mb-2">Contact ERAL support team</p>
            <button className="bg-white text-[#123ef6] px-3 py-1 rounded text-sm font-medium hover:bg-gray-100 transition-colors">
              Get Support
            </button>
          </div>
        </div>
